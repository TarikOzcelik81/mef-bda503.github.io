...
# Download 2016-11 data and add to main data
print("Getting 2016-11 data from repository")
download.file("https://github.com/MEF-BDA503/pj18-TarikOzcelik81/blob/master/odd_car_sales_data_nov_16.rds?raw=true",destfile=tmprds)
main_data <- bind_rows(main_data,readRDS(tmprds))
